const data = [
  ...
  },
  {
    ...
    leftStatus: {
      leftDueToHealth: 0,
      notLeftDueToHealth: 83.33,
      notSureDueToHealth: 16.67,
    },
    healthWellBeingOffered: 100,
    employeeCareByIndustry: {
      careAboutTeam: 100,
      increasesProductivity: 16.67,
      dontCare: 0,
    },
    healthWellBeingIssue: [{
      name: "Mental health",
  ...
  },
  {
    ...
    leftStatus: {
      leftDueToHealth: 25,
      notLeftDueToHealth: 62.50,
      notSureDueToHealth: 12.50,
    },
    healthWellBeingOffered: 62.50,
    employeeCareByIndustry: {
      careAboutTeam: 62.50,
